...
app.get("/search", (req, res) => {
    ...
    let filteredArticles: NewsArticle[] = [...articles].filter(articles => articles.title.includes(q) || articles.content.includes(q))
    
    res.render("search", { articles: filteredArticles, q });
})
